...
interface Essay {
    ...
    user_id: string;
    content: string;
    score: string; // JSON String or Simple String
                    ...
                    <div className="bg-white w-full max-w-3xl p-8 md:p-12 rounded-3xl shadow-xl border border-slate-100 relative">
                        ...
                        <div className="mt-12 flex justify-end">
                             <button 
                                ...
                                className="flex items-center gap-3 px-8 py-4 bg-slate-900 text-white rounded-full font-bold shadow-lg hover:bg-orange-600 hover:shadow-orange-500/30 hover:-translate-y-1 transition-all active:scale-95"
                            >
